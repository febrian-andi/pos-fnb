  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "POS App",
        short_name: "POS App",
        description: "A POS application designed to streamline the process of taking orders for food and beverages in restaurants or cafes. It offers features to efficiently manage customer orders.",
        theme_color: "#0A57FEFF",
        icons: [
          {
